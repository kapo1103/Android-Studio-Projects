...
class FotografPaylasmaActivity : AppCompatActivity() {
    ...
    fun gorselSec(view: View){
        ...
        //görsellere erişmek tehlikeli izin oldugu için kullanıcıdan uygulama üzerinde izin almalıyız
        if (ContextCompat.checkSelfPermission(this,android.Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){ // Manifest yazarken android olan seçilecek java değil importları farklı
            // izni almamışız
